...
from mpc import Action_Optimizer
...
parser.add_argument('--action-optimizer', action='store_true')
parser.add_argument('--env', type=str, default='ball_in_cup-catch', choices=GYM_ENVS + CONTROL_SUITE_ENVS, help='Gym/Control Suite environment')
...
if args.models != '':
  ...
  model_path = os.path.join(current_dir, args.models)
